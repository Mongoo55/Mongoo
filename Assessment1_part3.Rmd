...
fastfood%>%
ggplot(aes(x=calories, y=calcium, color=restaurant)) +
  geom_line()+
coord_flip()+
facet_wrap(~restaurant)
fastfood + theme_light()
```
...
library(dplyr)
trans_fat_percent <- 
  fastfood %>% count(restaurant, name="trans fat")
ggplot(trans_fat_percent, aes(x=restaurant, y=trans_fat_percent, fill=restaurant))+ geom_bar(stat = "count")
